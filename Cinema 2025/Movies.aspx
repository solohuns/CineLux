<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Movies.aspx.cs" Inherits="Cinema_2025.Movies" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    .movie-title {
        font-family: 'Cinzel', serif; /* Luxury modern font */
        font-size: 20px;
        font-weight: 600;
        margin-bottom: 6px;
        color: red;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-heading">All Movies</h1>
                ...
                <a href='Details.aspx?id=<%# Eval("MovieID") %>' class="movie-link">
                    <div class="movie-card">
                        ...
                        <div class="movie-meta">
                            ...
                            &nbsp;|&nbsp;
                            <asp:Label ID="DurationLabel" runat="server" Text='<%# Eval("Duration") %>' /> min
                        </div>
                    </div>
                </a>
            </ItemTemplate>
    ...
    <asp:SqlDataSource 
        ...
        SelectCommand="SELECT [MovieID], [Title], [Description], [Genre], [PosterImageURL], [Rating], [Country], [Format], [Duration] FROM [Movies]">
    </asp:SqlDataSource>
</asp:Content>
